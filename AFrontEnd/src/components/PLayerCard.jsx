...
const PLayerCard = () => {
  ...
  const hostIp = import.meta.env.VITE_HOST_IP;
     ...
     useState(() => {
       setmetaUrl(`SongMeta/${song}`)
       setStreamUrl(Url)
      //  console.log("nlPlayer",metaUrl )
    ...
    //  console.log(streamUrl);
     ...
     useEffect(() => {
      ...
      const fsong = () => axios.get(`/hi/${metaUrl}`)
        .then(
          (response) => {
...
<div class=" px-4 justify-center items-center h-screen">
  <div class="bg-gray-900 p-8 rounded-lg shadow-md h-[80%] md:w-64 sm:min-w-8 ">
    {/* <!-- Album Cover --> */}
