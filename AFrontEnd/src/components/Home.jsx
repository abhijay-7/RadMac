...
<Link to={`/playlist/${item.id}`}>
            <button onClick={console.log("clicked")} class="hover:scale-110 text-white opacity-0 transform translate-y-3 group-hover:translate-y-0 group-hover:opacity-100 transition">
      ...
      {/* <div className="z-50 fixed bottom-0 left-0 right-0 bg-gray-900 flex justify-around py-3 border-t border-gray-800">
